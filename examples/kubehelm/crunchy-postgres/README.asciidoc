...
using the Helm project!  More examples of the Crunchy Containers
for Postgres can be found at the link:https://github.com/crunchydata/crunchy-containers/[github site]. 
 ...
 * postgres 9.5 replica database pod

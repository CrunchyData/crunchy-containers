...
The above command changes the image tag of the container from the default of `centos7-11.13-4.5.4` to `centos7-9.6.11-2.2.0`.
...
| `.image.tag` | The image tag to be used.    | `centos7-11.13-4.5.4`                                                    |

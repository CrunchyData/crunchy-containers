...
The above command changes the image tag of the container from the default of `centos7-10.7-2.4.0-rc4` to `centos7-9.6.11-2.2.0`.
...
| `.image.tag` | The image tag to be used.    | `centos7-10.7-2.4.0-rc4`                                                    |

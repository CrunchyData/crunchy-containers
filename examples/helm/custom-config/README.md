...
```console
$ helm install custom-config --name custom-config \
  --set Image.tag=ubi8-13.9-4.6.9
```

The above command changes the image tag of the container to of `ubi8-13.9-4.6.9`.
...
| `.image.tag` | The image tag to be used.    | `ubi8-13.9-4.6.9`                                                    |

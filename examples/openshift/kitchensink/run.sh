...
oc process -v CCP_IMAGE_TAG=$CCP_IMAGE_TAG -f $DIR/ks-replica-dc.json | oc create -f -
echo "create sync replica pod.."
oc process -v CCP_IMAGE_TAG=$CCP_IMAGE_TAG -f $DIR/ks-sync-replica-pod.json | oc create -f -

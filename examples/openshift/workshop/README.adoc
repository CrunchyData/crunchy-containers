...
docker pull crunchydata/crunchy-postgres-gis:centos7-10.1-1.7.1
docker pull crunchydata/crunchy-backup:centos7-10.1-1.7.1
docker pull crunchydata/crunchy-collect:centos7-10.1-1.7.1
docker pull crunchydata/crunchy-pgbadger:centos7-10.1-1.7.1
docker pull crunchydata/crunchy-pgadmin4:centos7-10.1-1.7.1
docker pull crunchydata/crunchy-prometheus:centos7-10.1-1.7.1
docker pull crunchydata/crunchy-promgateway:centos7-10.1-1.7.1
docker pull crunchydata/crunchy-grafana:centos7-10.1-1.7.1
docker pull crunchydata/crunchy-watch:centos7-10.1-1.7.1
....
...
oc new-app -p CCP_IMAGE_TAG=centos7-10.1-1.7.1 -f primary.json
oc new-app -p CCP_IMAGE_TAG=centos7-10.1-1.7.1 -f replicas.json
oc new-app -p CCP_IMAGE_TAG=centos7-10.1-1.7.1 -f pgadmin4.json
oc new-app -p CCP_IMAGE_TAG=centos7-10.1-1.7.1 -f metrics.json
oc policy add-role-to-group edit system:serviceaccounts -n default
oc new-app -p CCP_IMAGE_TAG=centos7-10.1-1.7.1 -f watch.json

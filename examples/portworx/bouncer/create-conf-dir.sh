...
echo "creating conf dir in bouncer-conf-volume..."

docker stop bouncer-setup bouncer-ls
docker rm bouncer-setup bouncer-ls
...
docker run \
	...
	--name=bouncer-setup \
	--hostname=bouncer-setup \
	crunchydata/crunchy-pgbouncer:centos7-9.5-$CCP_VERSION find /myhostdir -exec cp {} /pgconf \; -print
...
docker run \
	...
	--name=bouncer-ls \
	--hostname=bouncer-ls \
	crunchydata/crunchy-pgbouncer:centos7-9.5-$CCP_VERSION find /pgconf

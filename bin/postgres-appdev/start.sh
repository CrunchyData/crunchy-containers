...
### Need to remove all the options for replicas or just hard code this is master AND autgenerate passwords
...
# We are going to randomly generate these
...
export PG_PRIMARY_USER="user"$(openssl rand -base64 9)
export PG_PRIMARY_PASSWORD="pass"$(openssl rand -base64 9)

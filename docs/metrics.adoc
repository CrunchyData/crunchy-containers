 ...
 * http://crunchy-metrics:19090 - the Prometheus web user interface
 * http://crunchy-metrics:19091 - the Prometheus pushgateway REST API
 * http://crunchy-metrics:13000 - the Grafana web user interface

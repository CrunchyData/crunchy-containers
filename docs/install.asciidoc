...
See link:examples.asciidoc[here] to view the documentation showing various
examples.
...
Visit the link:examples.asciidoc[examples documentation] for different use cases
and examples.

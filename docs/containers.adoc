 ...
 * PG_PRIMARY_SERVICE_NAME - database host to connect to for the master node
 ...
 * PG_PRIMARY_SERVICE -  the master service name
 ...
 * PG_PRIMARY_PORT - the PostgreSQL port to use when checking the master
 * PG_PRIMARY_SERVICE - the name of the master database container

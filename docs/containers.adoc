 ...
 * REPLICA_TO_TRIGGER_LABEL - this is the pod name of a replica that you
 ...
 * will look for replicas that have the metadata label value of *replicatype=trigger* to prefer

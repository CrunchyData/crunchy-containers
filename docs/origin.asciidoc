...
This instruction assumes you are installing on Centos 7 or RHEL 7 and have 
followed the initial environment setup found  
link:https://github.com/crunchydata/crunchy-containers/blob/master/docs/install.asciidoc[here].
...
To set up dnsmasq, this set of instructions is most helpful:

http://developers.redhat.com/blog/2015/11/19/dns-your-openshift-v3-cluster/

Alternatively, on my dev setup, I use KVM (libvirt) to run OSE within

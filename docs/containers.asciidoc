...
crunchy-collect to the prometheus pushgateway found in the crunchy-pushgateway
 ...
 * crunchy-pushgateway:9091 - the prometheus pushgateway REST API
 ...
 * PROM_GATEWAY - the http URL of the prometheus pushgateway into which the metrics will be pushed.  defaults to http://crunchy-pushgateway:9091
...
image::pgadmin4-screenshot.png?raw=true[]

...
If you haven't already followed the instructions in the
link:https://github.com/CrunchyData/crunchy-containers/blob/master/docs/install.asciidoc[install documentation],
...
all you'll need to do is follow this script:

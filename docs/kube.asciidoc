...
export PATH=$PATH:~/kubernetes/_output/release-stage/client/linux-amd64/kubernetes/client/bin
....
...
inside it:
 * kitchensink-master (postgres container)
 * pg-badger (pgbadger container)

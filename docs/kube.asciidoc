...
the openshift.asciidoc, Example 20 for details on how
the PITR example works.
...
See link:pitr.asciidoc for details on PITR concepts and how PITR is implemented
within the Suite.

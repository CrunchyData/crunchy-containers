...
==== PostGIS validation steps (all platforms)
...
....
psql -h postgres-gis -U testuser -c "SELECT postgis_full_version();"
....
...
....
psql -h postgres-gis -U testuser -c "select ST_MakePoint(28.385200,-81.563900);"
....

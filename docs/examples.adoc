...
*Note*: This example works on both Kube and Openshift.  Set the CCP_CLI environment variable
...
For a production Kubernetes and Openshift installations, you'll likely want DNS

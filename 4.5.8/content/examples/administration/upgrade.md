...
such as `centos7-{{< param postgresVersion12 >}}-{{< param containersVersion >}}` prior to running this upgrade.
{{% /notice %}}
...
sure the variable references a PostgreSQL 12 image such as `centos7-{{< param postgresVersion12 >}}-{{< param containersVersion >}}`.
